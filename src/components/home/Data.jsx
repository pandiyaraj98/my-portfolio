...
export const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title text-lg-center">
                Pandiyaraj R
                <svg
                    width="36"
                    height="36"
            ...
            <h3 className="home_subtitle typewriter">Web Developer Fresher</h3>
            <p className="home_description">
                A passionate and aspiring full-stack developer eager to embark on exciting projects and contribute to innovative solutions. Here you'll find an overview of my skills, projects, and experiences in web development.
            </p>
